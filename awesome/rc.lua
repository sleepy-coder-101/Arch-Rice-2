...
awful.keyboard.append_global_keybindings({
   awful.key({ modkey,           }, "s",      hotkeys_popup.show_help,
	...
	--My shortcuts
	awful.key({ modkey }, "q", function() awful.util.spawn("rofi -show drun") end,
              {description = "show the rofi menu", group = "launcher"}),
	awful.key({ modkey }, "w", function () awful.spawn(browser) end,
              {description = "run browser", group = "launcher"}),
	awful.key({ }, "XF86MonBrightnessUp", function () os.execute("brillo -A 5") end,
              {description = "+5%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("brillo -U 5") end,
              {description = "-5%", group = "hotkeys"}),
